...
class CategoryView {
  ...
  createCategoriesList() {
    ...
    const categoryDOM = document.querySelectorAll("#product-category");
    const www = document.querySelectorAll("#product-categoryy");
    categoryDOM.forEach((r)=>r.innerHTML=result);
    www.forEach((r)=>r.innerHTML=result);
